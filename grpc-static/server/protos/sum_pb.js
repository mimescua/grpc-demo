...
proto.sum.SumRequest.toObject = function(includeInstance, msg) {
  var f, obj = {
    addendOne: jspb.Message.getFieldWithDefault(msg, 1, 0),
    addendTwo: jspb.Message.getFieldWithDefault(msg, 2, 0)
  };
...
proto.sum.SumRequest.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    case 1:
      ...
      msg.setAddendOne(value);
      break;
    case 2:
      var value = /** @type {number} */ (reader.readInt32());
      msg.setAddendTwo(value);
      break;
    default:
      reader.skipField();
      break;
...
/**
 * optional int32 addend_one = 1;
 * @return {number}
 */
proto.sum.SumRequest.prototype.getAddendOne = function() {
 ...
 */
proto.sum.SumRequest.prototype.setAddendOne = function(value) {
  return jspb.Message.setProto3IntField(this, 1, value);
};


/**
 * optional int32 addend_two = 2;
 * @return {number}
 */
proto.sum.SumRequest.prototype.getAddendTwo = function() {
 ...
 * @return {!proto.sum.SumRequest} returns this
 */
proto.sum.SumRequest.prototype.setAddendTwo = function(value) {
 ...
 * @return {number}
 */
proto.sum.SumResponse.prototype.getSumResult = function() {
  return /** @type {number} */ (jspb.Message.getFieldWithDefault(this, 1, 0));
};
 ...
 */
proto.sum.SumResponse.prototype.setSumResult = function(value) {
  return jspb.Message.setProto3IntField(this, 1, value);
};
